...
public class RSA {
   ...
   public static RSA getEncKey() {
      ...
      generator.initialize(1024); //�궎 �궗�씠利�
      ...
      PublicKey publicKey = keyPair.getPublic(); //怨듦컻�궎
      PrivateKey privateKey = keyPair.getPrivate(); //媛쒖씤�궎
   ...
   public static boolean dec(PrivateKey privateKey, String encString) throws Exception{
      ...
      if (privateKey == null) {
            throw new RuntimeException("�븫�샇�솕 鍮꾨��궎 �젙蹂대�� 李얠쓣 �닔 �뾾�뒿�땲�떎.");
        }
      try {
   ...
   public static String decryptRsa(PrivateKey privateKey, String securedValue) throws Exception {
        ...
        String decryptedValue = new String(decryptedBytes, "utf-8"); // 臾몄옄 �씤肄붾뵫 二쇱쓽.
